...
getwd()
setwd("/Users/Chase/R-PROGRAMMING-A-Z/Section5")
getwd()
...
myplot <- function(data,title) {
  qplot(data=data, x=Fertility.Rate, y=Life.Exp,
...
myplot(merged1960, "Life Expectancy vs Fertility (1960)")

#Visualize the 2013 dataset
myplot(merged2013, "Life Expectancy vs Fertility (2013)")
